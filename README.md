...
Simply replace your GitHub Pages files with these updated versions:
- index.html
- script.js
- styles.css
- CNAME
...
Your site will continue working exactly as before, but mice and mousepads will now show as a clean list!
